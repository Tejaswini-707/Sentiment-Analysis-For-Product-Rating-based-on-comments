...
<a href="homepage.php" class="ref">Home</a>			<a href="product.php"class="ref">Electronics</a>			<a href="comming.html"class="ref">Furniture</a>			<a href="comming.html"class="ref">Clothing</a></pre>
	...
	<div>
		...
		<div class="row">
			...
			<h1  style="text-align:left;margin-right:20px;"><font color="blue">Apple iPhone 11 Pro</font><h1>
			<h3  style="text-align:left;margin-right:20px;">Manufacturer	:	Apple</h3>
			<h3  style="text-align:left;margin-right:20px;">Model	:	Apple iPhone 11 Pro</h3>
			<h3  style="text-align:left;margin-right:20px;">Price 		: 31,07,100</h3>
			<h3  style="text-align:left;margin-right:20px;">Operating System	:	iOS</h3>
			<h3  style="text-align:left;margin-right:20px;">Os Version	:	13</h3>
...
<form action="appledatabase.php" method="post">
...
?>
			...
			<img src="11pro.png" alt="not found" style="width:400px;height:400px;margin-right:130px; margin-top:50px; ">
