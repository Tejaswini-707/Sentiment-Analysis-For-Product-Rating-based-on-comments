...
<a href="homepage.php" class="ref">Home</a>			<a href="product.php"class="ref">Electronics</a>			<a href="comming.html"class="ref">Furniture</a>			<a href="comming.html"class="ref">Clothing</a></pre>
	...
	<div>
		...
		<div class="row">
			...
			<h1  style="text-align:left;margin-right:20px;"><font color="blue">Oppo F15</font><h1>
			<h3  style="text-align:left;margin-right:20px;">Manufacturer	:	Oppo</h3>
			<h3  style="text-align:left;margin-right:20px;">Model	:	F15</h3>
			<h3  style="text-align:left;margin-right:20px;">Price 		: 18,328</h3>
		   ...
		   <form action="oppodatabase.php" method="post">
...
?>
			...
			<img src="oppo.png" alt="not found" style="width:400px;height:400px;margin-right:130px; margin-top:50px; ">
