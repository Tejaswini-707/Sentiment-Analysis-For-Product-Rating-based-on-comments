...
<a href="homepage.php" class="ref">Home</a>			<a href="product.php"class="ref">Electronics</a>			<a href="comming.html"class="ref">Furniture</a>			<a href="comming.html"class="ref">Clothing</a></pre>
	...
	<div>
		...
		<div class="row">
			...
			<h1  style="text-align:left;margin-right:20px;"><font color="blue">Redmi Note 8 Pro</font><h1>
			<h3  style="text-align:left;margin-right:20px;">Manufacturer	:	Xiaomi</h3>
			<h3  style="text-align:left;margin-right:20px;">Model	:	Xiaomi Redmi Note 8 Pro</h3>
			<h3  style="text-align:left;margin-right:20px;">Price 		: 15999</h3>
			<h3  style="text-align:left;margin-right:20px;">Operating System	:	Android</h3>
			<h3  style="text-align:left;margin-right:20px;">Os Version	:	9</h3>
...
<form action="midatabase.php" method="post">
...
// Create connection
	$conn = mysqli_connect("localhost","root","", "logininfo3");
...
?>
			...
			<img src="redmi8.png" alt="not found" style="width:400px;height:400px;margin-right:130px; margin-top:50px; ">
